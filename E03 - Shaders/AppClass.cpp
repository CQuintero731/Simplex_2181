...
{
	m_uShaderProgramID = LoadShaders("Shaders//BasicColor.vs", "Shaders//E03Shader.fs");
...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
    if (a_event.key.code == sf::Keyboard::Key::Escape)//Event says I pressed the Escape key
        ...
        m_isComplimentary = !m_isComplimentary;
...
void AppClass::Display(void)
{
    ...
    glUniform1f(Complimentary, m_isComplimentary);
