...
private:
	...
	std::vector<std::vector<vector3>> mStopsLists;//A list of the list of all stops for each torus we have
	int mStopCounter = 0;//Counter to check for each stop we have made
